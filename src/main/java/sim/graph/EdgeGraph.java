...
/**
 * Represents an edge in a graph, extending the JTS (Java Topology Suite) Edge class. This class is
 * a component of graphs that are part of the {@link Graph} class, along with {@link NodeGraph}. It
 * encapsulates additional attributes and functionalities specific to the graph's edges.
 */
public class EdgeGraph extends Edge {
  ...
  /**
   * Returns the deflection angle if this edge is a dual edge and represents a link between two dual
   * nodes (street segment).
   *
   * @return The deflection angle of the dual edge, if applicable; otherwise, it returns 0.0.
   */
   ...
   * @return The other node connected to this edge, or null if the provided node is not connected to
   *         this edge.
   */
   ...
   * @return The common node if found, or null if there is no common node between the edges.
   */
