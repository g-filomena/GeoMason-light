...
public class ShapeFileExporter {
  ...
  /**
   * Write the given vector field to a shape file. The three mandatory shape files (".shp", ".shx",
   * and ".dbf") will be created using the given base file name prefix.
   *
  ...
  private static Map<String, Integer> determineAttributeSizes(List<MasonGeometry> geometries) {
    Map<String, Integer> attributeSizes = new HashMap<>();
