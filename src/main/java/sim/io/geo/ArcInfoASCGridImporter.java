...
public class ArcInfoASCGridImporter // extends GeomImporter
{
   ...
   * @see read()
   */
  private static void readIntegerBased(Scanner scanner, int width, int height, IntGrid2D intGrid2D)
      throws IOException {
    int currentInt;
   ...
   * @see read()
   */
  private static void readDoubleBased(Scanner scanner, int width, int height,
      DoubleGrid2D doubleGrid2D) throws IOException {
