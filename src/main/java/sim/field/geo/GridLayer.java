...
public class GridLayer extends Layer {
   ...
   *
   * XXX Maybe consider Abstract2DGrid instead? But that would eliminate possibly using
   * Sparse2DGrid.
   *
   */
  ...
  public GridLayer(Grid2D wrappedGrid) {
    super();
  ...
  /**
   * Returns width of grid in pixels. By contrast, super.getWidth() returns width in spatial
   * reference context.
   *
  ...
  public Polygon toPolygon(int x, int y) {
    ...
    Polygon polygon = geometryFactory.createPolygon(ring, null); // null means no inner rings; i.e.,
                                                                 // no hollow parts
