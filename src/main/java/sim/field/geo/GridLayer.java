...
public class GridLayer extends Layer {
	 ...
	 * Grid container
	 * 
	 * Allows for the user to use an arbitrary grid of integers, doubles, or
	 * objects.
	 *
	...
	/**
	 * Returns width of grid in pixels. By contrast, super.getWidth() returns width
	 * in spatial reference context.
	 *
