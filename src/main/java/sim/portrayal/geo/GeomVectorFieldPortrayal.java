...
public class GeomVectorFieldPortrayal extends FieldPortrayal2D {
	...
	/**
	 * Returns the appropriate Portrayal. See the class header for more information
...
//        }
		...
		GeomInfo2D newinfo = new GeomInfo2D(
				new DrawInfo2D(info.gui, info.fieldPortrayal, new Rectangle2D.Double(0, 0, xScale, yScale), info.clip),
