 ...
 * It contains static methods to calculate angles between points, compute
 * angular differences, and perform various angle-related calculations.
 */
public class Angles {

	/**
	 * Computes the dot product between two vectors represented as arrays of
	 * doubles.
	 *
	 ...
	 *
	 * This method calculates the angle in degrees between two NodeGraph instances,
	 * where 'originNode' represents the starting point, and 'destinationNode'
	 * represents the ending point. The angle is measured with respect to the
	 * positive y-axis.
	 *
	 * @param originNode      The starting NodeGraph.
	 * @param destinationNode The ending NodeGraph.
	 * @return The angle in degrees between the two NodeGraph instances with respect
	 *         to the y-axis.
	 */
	...
	/**
	 * Computes the angle in degrees formed by two sets of coordinates with respect
	 * to the y-axis.
	 *
	 * This method calculates the angle between two sets of coordinates, where the
	 * first set represents the origin and the second set represents the
	 * destination. The angle is measured with respect to the positive y-axis and
	 * returned in degrees.
	 *
	 * @param origin      The coordinates of the origin point.
	 * @param destination The coordinates of the destination point.
	 * @return The angle in degrees between the origin and destination with respect
	 *         to the y-axis.
	 */
	...
	/**
	 * Calculates the angular difference between two angles, considering their
	 * orientation.
	 *
	 * This method computes the absolute angular difference between two angles,
	 * taking into account their orientations in degrees. The result is the smallest
	 * angular difference between the two angles, considering both positive and
	...
	/**
	 * Checks whether an angle between an origin and a second node falls within a
	 * specified cone.
	 *
	 ...
	 * intermediate node (angleON), and the amplitude of the cone (cone), lies
	 * within the specified cone.
	 *
	 * @param angleOD The angle between the origin and the destination node in
	 *                degrees.
	 * @param angleON The angle between the origin and the intermediate node in
	 *                degrees.
	...
	/**
	 * Calculates the coordinate at a specified angle and distance from the given
	 * origin node.
	 *
	 ...
	 *
	 * @param originNode The origin node from which to measure the angle and
	 *                   distance.
	 * @param distance   The distance from the origin node to the target coordinate.
	 * @param angle      The angle in degrees at which to position the target
	 *                   coordinate.
	 ...
	 *
	 * Given two NodeGraph instances and half of the amplitude of a desired angle
	 * (either positive or negative, e.g. + 35.0° or - 35.0° --> 70°), this method
	 * computes the coordinate of a point that, when connected with the first node,
	 * forms one of the lines of the view cone.
	 *
	...
	/**
	 * Computes the view field geometry between two nodes based on a specified field
	 * of view angle. The view field represents the region visible from the first
	 * node to the second node within the given field of view angle.
	 *
	 ...
	 * @param fieldOfView The field of view angle in degrees (half of the total
	 *                    angle).
