...
/**
 * A MasonGeometry is a wrapper for a JTS geometry and an associated userData field. The userData
 * field can be any MASON object, or general Java object, which will be included in the inspector by
 * default.
 *
 * <p>
 * MasonGeometry implements sim.util.Proxiable to allow the hiding of various getXXX and setXXX
 * methods from the inspectors.
 *
 * TODO may have to move new AttributeValue convenience functions to inner proxy class.
 */
public class MasonGeometry implements sim.util.Proxiable, java.io.Serializable {
  ...
  public boolean equals(final Object obj) {
    ...
    if (attributes != other.attributes
        && (attributes == null || !attributes.equals(other.attributes))) {
      return false;
    }
  ...
  /**
   * Inner class allows us to prevent certain getXXX and setXXX methods from appearing in the
   * Inspector
   */
  public class GeomWrapperProxy {

    /**
     * @return the area of the internal JTS geometry object. The units are the same as same as the
     *         internal JTS geometry object
     */
    ...
    /**
     * @return the length of the perimeter of the internal JTS geometry object. The units are the
     *         same as same as the internal JTS geometry object
     */
