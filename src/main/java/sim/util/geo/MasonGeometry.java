 ...
 *
 * <p>
 * MasonGeometry implements sim.util.Proxiable to allow the hiding of various
 * getXXX and setXXX methods from the inspectors.
 *
 * TODO may have to move new AttributeValue convenience functions to inner proxy
 * class.
 */
public class MasonGeometry implements sim.util.Proxiable, java.io.Serializable {
	...
	/**
	 * A cached, optimized version of my Geometry. Used for fast intersection,
	 * union, etc. operations, This instance is not serializable, thus we declare it
	 * transient
	 */
	...
	public class GeomWrapperProxy {
		...
		/**
		 * @return the area of the internal JTS geometry object. The units are the same
		 *         as same as the internal JTS geometry object
		 */
		...
		/**
		 * @return the length of the perimeter of the internal JTS geometry object. The
		 *         units are the same as same as the internal JTS geometry object
		 */
