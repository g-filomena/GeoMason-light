...
/**
 * The class provides utility methods for working with CSV (Comma-Separated Values) data. It allows
 * you to write CSV lines to a Writer, handling various separators and custom quotes.
 */
public class CSVUtils {
  ...
  /**
   * Writes a CSV line to the provided Writer using the default separator (',') and no custom
   * quotes.
   *
